  ...
  return (
    <div className="pb-24">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        {/* Background image */}
        <div
          className="absolute inset-0 opacity-30 scale-105 blur-sm"
          style={{
          ...
          {project.demoUrl && (
            <Reveal delay={300}>
              <MagneticButton
                ...
                className={`inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-bold text-lg ${theme.accentBg} ${theme.accentHover} shadow-2xl ${theme.accentShadow} transition-all`}
              >
            ...
            <Reveal delay={200}>
              ...
              >
                ...
                {project.gallery.length > 1 && (
                  <div className="flex gap-2.5 mt-3 px-1 overflow-x-auto scrollbar-hide">
